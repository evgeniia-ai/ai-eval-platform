...
REGRESSION_SET — 11 calls, covering high- and low-quality examples across
...
REGRESSION_SET: frozenset[str] = frozenset({
    ...
    "HB-SYNTH-00101",  # appointment_scheduling — low, synthetic
    ...
    "HB-SYNTH-00103",  # insurance_verification — high, synthetic
